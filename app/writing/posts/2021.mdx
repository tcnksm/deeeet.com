...
summary: "Transitioned from Staff engineer to engineering manager at Mercari, leading platform DX and embedding SRE teams. Focused on infrastructure engineering division, developed Kubernetes manifest abstraction framework and security tooling. Started e34.fm podcast with 12 episodes released. Keynote speaker at CloudNative Days Tokyo on platform security hardening."
---
